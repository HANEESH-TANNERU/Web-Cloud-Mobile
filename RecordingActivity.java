...
public class RecordingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnStartRecord = findViewById(R.id.Begin);
        btnStopRecord = findViewById(R.id.End);
        btnStartPlay = findViewById(R.id.AudioPlay);
        btnStopPlay = findViewById(R.id.StopPlay);
        if (!checkPermission()) {
            requestPermission();
        }
    }
