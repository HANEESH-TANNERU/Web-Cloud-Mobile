...
function win(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " You chose: " + convertToWord(userOption) + ". Computer chose: " + convertToWord(computerOption) + ". YOU WIN! Wanna Play again.";
    document.getElementById("resultImg").src="win.jpg";
}

function lose(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " You chose: " + convertToWord(userOption) + ". Computer chose: " + convertToWord(computerOption) + ". YOU LOST! Wanna Play Again.";
    document.getElementById("resultImg").src="lost.png";
}

function draw(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " You chose: " + convertToWord(userOption) + ". Computer chose: " + convertToWord(computerOption) + ". IT'S A DRAW! Wanna Play Again.";
    document.getElementById("resultImg").src="tie.png";
}
